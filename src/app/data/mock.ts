export const MOCK_STUDENTS = [
  ...
  },
  {
    ...
    interests: ["システムズエンジニアリング", "電源系", "小型衛星"],
  ...
  },
  {
    ...
    interests: ["メカトロニクス", "機械システム", "探査ローバー"],
  ...
  },
  {
    ...
    interests: ["データサイエンス", "機械学習", "宇宙ビッグデータ"],
  ...
  },
  {
    ...
    interests: ["リモートセンシング", "地球観測", "環境モニタリング"],
  ...
  },
  {
    ...
    interests: ["航空宇宙工学", "軌道設計", "システムズエンジニアリング"],
    skills: ["Python", "MATLAB", "C++", "SolidWorks", "STK"],
...
export const MOCK_COMPANY_STATS = {
  ...
  skillDistribution: [
    ...
    { tag: "MATLAB", count: 17 },
    { tag: "C++", count: 12 },
    { tag: "SolidWorks", count: 8 },
    { tag: "C", count: 7 },
    { tag: "機械学習", count: 5 },
    { tag: "ROS/ROS2", count: 5 },
    { tag: "推進系", count: 5 },
    { tag: "FPGA", count: 2 },
    { tag: "リモートセンシング", count: 2 }
  ]
};
