export const MOCK_STUDENTS = [
  {
    ...
    careerVision: "宇宙分野での研究開発に携わり、社会実装を通じて価値を生み出したい。",
    history: [
    ...
    summary: {
      // 上部サマリー用の短文（before/after を要約したもの）
      before: "熱・意欲の証はあるが、実システムへの応用経験は限定的。チーム開発の経験も少ない。",
      after: "システム全体での設計力が向上。チームで価値を出すプロセスを経験し、実践力と発信力が向上。",
      programName: "AstroCamp 2025",
      programTitle: "姿勢制御コンテンツの開発に参加",
    },
    skillMatrix: {
